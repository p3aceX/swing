...
class _LaneTab extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final fg = active ? accent : _c.muted;
    return Expanded(
            ...
            children: [
              ...
              if (count > 0) ...[
                ...
                Container(
                  ...
                  decoration: BoxDecoration(
                    color: active ? accent : _c.faint.withValues(alpha: 0.18),
