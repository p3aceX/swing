...
public final class zzdl implements zzdd {
    ...
    public final void zza(int i4, zzcj zzcjVar, zzpq... zzpqVarArr) throws zzae {
        ...
        Object[] objArrZzh = zzcjVar.zzc().zzh(AbstractC0726f.n0(zzpqVarArr).subList(2, length));
        try {
            zzcjVar.zzc().zzf(i4, method.invoke(objZza2, Arrays.copyOf(objArrZzh, objArrZzh.length)));
        } catch (Exception e) {
