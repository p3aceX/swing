...
final class zzhk {
    public static /* bridge */ /* synthetic */ void zza(byte b5, byte b6, byte b7, byte b8, char[] cArr, int i4) throws zzfb {
        if (!zze(b6)) {
    ...
    */
    ...
    public static /* bridge */ /* synthetic */ void zzc(byte b5, byte b6, char[] cArr, int i4) throws zzfb {
        if (b5 < -62 || zze(b6)) {
            throw zzfb.zzb();
        }
