...
public final class zzach {
    ...
    */
    public static g1.h zza(com.google.android.gms.common.api.Status r3) {
        /*
            Method dump skipped, instruction units count: 546
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.internal.p002firebaseauthapi.zzach.zza(com.google.android.gms.common.api.Status):g1.h");
    }

    private static String zzb(int i4) {
        Pair<String, String> pair = zza.get(i4);
        return pair != null ? (String) pair.second : "An internal error has occurred.";
    }

    public static boolean zzc(Exception exc) {
        if (exc instanceof i) {
            return ((i) exc).f5201a.endsWith("MISSING_RECAPTCHA_TOKEN");
        }
        return false;
    }
    ...
    public static boolean zzb(Exception exc) {
        if (exc instanceof i) {
            return ((i) exc).f5201a.endsWith("INVALID_RECAPTCHA_TOKEN");
        }
        return false;
    }

    public static h zza(Status status, AbstractC0458c abstractC0458c, String str, String str2) {
        int i4 = status.f3378b;
        if (i4 != 17012 && i4 != 17007 && i4 != 17025) {
            return zza(status);
        }
        return new j1.h(zza(i4), zza(zzb(i4), status));
    }

    private static String zza(String str, Status status) {
        return TextUtils.isEmpty(status.f3379c) ? str : String.format(S.f(str, " [ %s ]"), status.f3379c);
    }

    public static j zza(FirebaseAuth firebaseAuth, zzyi zzyiVar, l lVar) {
        zzz.zza(firebaseAuth);
        zzz.zza(zzyiVar);
        Pair<String, String> pair = zza.get(17078);
        String str = (String) pair.first;
        String str2 = (String) pair.second;
        List<p> listZzc = zzyiVar.zzc();
        ...
        List<p> listZzc2 = zzyiVar.zzc();
        ArrayList arrayList2 = new ArrayList();
        for (p pVar2 : listZzc2) {
            if (pVar2 instanceof x) {
                arrayList2.add((x) pVar2);
            }
        }
        List<p> listZzc3 = zzyiVar.zzc();
        String strZzb = zzyiVar.zzb();
        F.g(listZzc3);
        F.d(strZzb);
        ArrayList arrayList3 = new ArrayList();
        ArrayList arrayList4 = new ArrayList();
        for (p pVar3 : listZzc3) {
            if (pVar3 instanceof u) {
                arrayList3.add((u) pVar3);
            } else if (pVar3 instanceof x) {
                arrayList4.add((x) pVar3);
            } else {
                throw new IllegalArgumentException("MultiFactorInfo must be either PhoneMultiFactorInfo or TotpMultiFactorInfo. The factorId of this MultiFactorInfo: ".concat(pVar3.b()));
            }
        }
        f fVar = firebaseAuth.f3841a;
        fVar.a();
        zzyiVar.zza();
        F.d(fVar.f4308b);
    ...
    public static boolean zza(Exception exc) {
        if (exc instanceof i) {
            return ((i) exc).f5201a.endsWith("ALTERNATE_CLIENT_IDENTIFIER_REQUIRED");
        }
        return false;
    }
}
