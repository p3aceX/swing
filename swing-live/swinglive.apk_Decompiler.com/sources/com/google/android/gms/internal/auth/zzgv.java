...
class zzgv extends AbstractMap {
    ...
    public /* synthetic */ zzgv(int i4, zzgu zzguVar) {
        this.zza = i4;
    ...
    private final int zzk(Comparable comparable) {
        ...
        int i5 = 0;
        if (i4 >= 0) {
            int iCompareTo = comparable.compareTo(((zzgp) this.zzb.get(i4)).zza());
            if (iCompareTo > 0) {
                return -(size + 1);
            }
            if (iCompareTo == 0) {
        ...
        while (i5 <= i4) {
            int i6 = (i5 + i4) / 2;
            int iCompareTo2 = comparable.compareTo(((zzgp) this.zzb.get(i6)).zza());
            if (iCompareTo2 < 0) {
                i4 = i6 - 1;
            } else {
                if (iCompareTo2 <= 0) {
    ...
    public final Object zzl(int i4) {
        zzn();
        Object value = ((zzgp) this.zzb.remove(i4)).getValue();
        if (!this.zzc.isEmpty()) {
    ...
    public final boolean equals(Object obj) {
        ...
        for (int i4 = 0; i4 < iZzb; i4++) {
            if (!zzg(i4).equals(zzgvVar.zzg(i4))) {
                return false;
            }
        }
        if (iZzb != size) {
    ...
    public final int hashCode() {
        ...
        int iHashCode = 0;
        for (int i4 = 0; i4 < iZzb; i4++) {
            iHashCode += ((zzgp) this.zzb.get(i4)).hashCode();
        }
    ...
    public final Object put(Comparable comparable, Object obj) {
        ...
        int i5 = this.zza;
        if (size == i5) {
            zzgp zzgpVar = (zzgp) this.zzb.remove(i5 - 1);
            zzm().put(zzgpVar.zza(), zzgpVar.getValue());
        }
        this.zzb.add(i4, new zzgp(this, comparable, obj));
        return null;
    }
